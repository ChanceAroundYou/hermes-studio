...
export default {
  ...
  profiles: {
    ...
    displayName: {
      title: '사용자 지정 이름',
      label: '표시 이름',
      placeholder: '비워 두면 프로필 이름을 사용합니다',
      hint: '표시 전용 — 프로필 디렉터리 이름은 변경되지 않습니다',
      customize: '이름',
      saveSuccess: '표시 이름을 저장했습니다',
      saveFailed: '표시 이름을 저장하지 못했습니다',
      reset: '프로필 이름 사용',
      resetSuccess: '프로필 이름으로 되돌렸습니다',
      resetFailed: '표시 이름을 초기화하지 못했습니다',
      tooLong: '표시 이름은 {max}자 이하여야 합니다',
    },
    provider: '공급자',
    path: '경로',
    skills: '스킬',
