...
export default {
  ...
  profiles: {
    ...
    switchTo: 'Focus Hermes Profile',
    switchConfirm: 'This will run `hermes profile use {name}` to update the CLI active-profile marker. Running tasks in all profiles are unaffected. Continue?',
    switchSuccess: 'Focused Hermes Profile "{name}"',
    switchFailed: 'Failed to focus Hermes profile. Gateway may need manual restart.',
    ...
    displayName: {
      title: 'Custom name',
      label: 'Display name',
      placeholder: 'Leave empty to use the profile name',
      hint: 'Display only — does not rename the profile directory',
      customize: 'Name',
      saveSuccess: 'Display name saved',
      saveFailed: 'Failed to save display name',
      reset: 'Use profile name',
      resetSuccess: 'Reverted to the profile name',
      resetFailed: 'Failed to reset display name',
    ...
    runtime: {
      ...
      switchProfile: 'Focus This Profile',
