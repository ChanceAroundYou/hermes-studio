...
export default {
  ...
  profiles: {
    ...
    displayName: {
      title: 'カスタム名',
      label: '表示名',
      placeholder: '空欄の場合はプロファイル名を使用します',
      hint: '表示のみ — プロファイルのディレクトリ名は変更されません',
      customize: '名前',
      saveSuccess: '表示名を保存しました',
      saveFailed: '表示名の保存に失敗しました',
      reset: 'プロファイル名に戻す',
      resetSuccess: 'プロファイル名に戻しました',
      resetFailed: '表示名のリセットに失敗しました',
      tooLong: '表示名は {max} 文字以内で入力してください',
    },
    provider: 'プロバイダー',
    path: 'パス',
    skills: 'スキル',
