...
export default {
  ...
  profiles: {
    ...
    delete: '删除',
    editConfig: '编辑配置文件',
    switchTo: '聚焦 Hermes Profile',
    switchConfirm: '将执行 `hermes profile use {name}` 更新 CLI active profile 标记，所有 profile 的运行任务不受影响。是否继续？',
    switchSuccess: '已聚焦 Hermes Profile "{name}"',
    switchFailed: '聚焦 Hermes Profile 失败，网关可能需要手动重启',
    ...
    displayName: {
      title: '自定义名称',
      label: '显示名称',
      placeholder: '不设置则显示配置名',
      hint: '仅影响界面显示，不会改变配置目录名',
      customize: '名称',
      saveSuccess: '显示名称已保存',
      saveFailed: '保存显示名称失败',
      reset: '恢复为配置名',
      resetSuccess: '已恢复为配置名',
      resetFailed: '恢复显示名称失败',
      tooLong: '显示名称最多 {max} 个字符',
    },
    provider: 'Provider',
    path: '路径',
    skills: '技能',
